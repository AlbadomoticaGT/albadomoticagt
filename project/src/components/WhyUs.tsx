...
const REASONS = [
  { num: "01", text: "Diagnóstico primero..", desc: " Revisamos tu instalación eléctrica antes de recomendar cualquier solución
    para asegurar compatibilidad y evitar sorpresas." },
